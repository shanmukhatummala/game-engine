...
public class MapSaver {
    ...
    /**
     * this method is called in the saveMap method to write all the continents and the bonus armies in a
     * specific format
    ...
    /**
     * this method is called in the saveMap method to write all the border of all countries as in a country and it's
     * neighbors
     * @param p_writer file writer object
     * @param p_map map object
     * @throws IOException
