...
public class MapValidator {
   ...
   * @return A list that represents whether or not each country has been visited during the DFS. The
   *     index of the list corresponds to those in the d_coutries data attribute of the Map object.
   */
  ...
  /**
   * Verifies if the map is valid. We consider that a map is correct when it represents a connected
   * graph, each continent also represents a connected subgraph, there are no empty continents and
   * each country has to have a unique name and id.
   *
   * @param p_mapToValidate The map that we want to validate.
