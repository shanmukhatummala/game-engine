...
public class DeployOrder extends Order{
     ...
     *      calls the super constructor (parent constructor) class and providing the parameters
    ...
    /**
     * Overriding the execute method for the deploy order this method just add the number of army deployed to the army count
     * of the country
     */
    @Override
    public void execute(){
