...
class PlayerTest {
  ...
  /**
   * This method test the issue order method by providing user two deploy command one is wrong anthe
   * other is correct and assert if the player reinforcements has been affected correctly after the
   * right command
   */
  @Test
