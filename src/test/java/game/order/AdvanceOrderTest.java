...
public class AdvanceOrderTest {
    ...
    public void testExecuteAdvanceOrderDestinationOwnerIsNotAdjacentToInitiator() {
        ...
        Advance l_advanceOrder = new Advance(l_destination, l_source, l_destinationOwner, l_initiator, 5);
        l_advanceOrder.execute();
    ...
    public void testValidMethodWhenDestinationIsNotValid() {
        ...
        Advance l_advanceOrder = new Advance(destination, source, l_destinationOwner, l_initiator, 5);
    ...
    /** Test case to verify the outcome of
     *  an attack on a territory when the attacker wins. */
    @Test
