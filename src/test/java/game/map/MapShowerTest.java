...
class MapShowerTest {
  ...
  void showMapTestNoOwner() {
    ...
    // Restoring the standard output and converting the captured output into lines so that we can
  ...
  void showMapTestOwner() {
    ...
    Country l_ostfriesland =
        new Country(1, "Ostfriesland", l_norddeutschland, new ArrayList<>(Arrays.asList(2, 3)), 0);
    Country l_holstein =
        new Country(2, "Holstein", l_norddeutschland, new ArrayList<>(Arrays.asList(1, 3)), 0);
    Country l_schleswig =
        new Country(3, "Schleswig", l_westdeutschland, new ArrayList<>(Arrays.asList(1, 2, 4)), 0);
    Country l_hamburg =
